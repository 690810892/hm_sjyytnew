...
public class ImageWay extends XtomObject {
    ...
    public void show() {
        ...
        if (mContext != null)
            ...
            mWindow_exit = new PopupWindow(mFragment.getActivity());
        ...
        mViewGroup_exit = (ViewGroup) LayoutInflater.from(mContext).inflate(
            ...
            mViewGroup_exit = (ViewGroup) LayoutInflater.from(mFragment.getActivity()).inflate(
                    R.layout.pop_type, null);
        man = (TextView) mViewGroup_exit.findViewById(R.id.tv_1);
        bt_cancel = (TextView) mViewGroup_exit.findViewById(R.id.tv_cancel);
        woman = (TextView) mViewGroup_exit.findViewById(R.id.tv_2);
