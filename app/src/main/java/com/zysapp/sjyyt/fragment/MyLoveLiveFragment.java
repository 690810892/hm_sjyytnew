 ...
 * 我喜欢的节目
 */
public class MyLoveLiveFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        adapter.setOnItemClickListener(new BaseRecycleAdapter.OnItemClickListener() {
            ...
            public void onClick(int position) {
                EventBus.getDefault().post(new EventBusModel(EventBusConfig.REFRESH_FIRST_SONG,blogs,position,4,1));
            }
        });
        carList(currentPage);
    ...
    private void carList(int page) {
        getNetWorker().liveLoveList(token,  page);
    }
